...
class EmployeeReviews < Minitest::Test
  ...
  def test_can_add_employee_to_a_department
    ...
    assert_equal 50000, new_employee.salary
  end
  ...
  def test_department_raises_based_on_criteria
    ...
    xavier.change_employee_performace(true)
    new_employee.change_employee_performace(true)
    old_employee.change_employee_performace(false)
  ...
  def test_number_of_employees_in_department
    ...
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    assert_equal a.employee_count, 3
  end
  ...
  def test_least_paid_employee_in_department
    ...
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    assert_equal a.least_paid, "Yvonne"
  end

  #This works, had trouble finding a good "test" for it"
  def test_employees_alphabetically_in_department
    a = Department.create!(name: "Marketing")
    xavier = Employee.create!(name: "Xavier", email: "ProfX@marvel.com", phone: "911", salary: 70000.00)
    new_employee = Employee.create!(name: "Dan", email: "d@mail.com", phone: "914-555-5555", salary: 50000.00)
    old_employee = Employee.create!(name: "Yvonne", email: "Yvonne@urFired.com", phone: "919-123-4567", salary: 40000.00)
    ...
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    assert a.alphabetize
  end

  def test_department_salary_average
    a = Department.create!(name: "Marketing")
    xavier = Employee.create!(name: "Xavier", email: "ProfX@marvel.com", phone: "911", salary: 70000.00)
    new_employee = Employee.create!(name: "Dan", email: "d@mail.com", phone: "914-555-5555", salary: 50020.00)
    old_employee = Employee.create!(name: "Yvonne", email: "Yvonne@urFired.com", phone: "919-123-4567", salary: 40000.00)
    a.add_employee(xavier)
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    assert_equal a.average_salary, 53340.0
  end

  #This works, had trouble finding a good "test" for it"
  def test_employees_salary_higher_than_department_average
    a = Department.create!(name: "Marketing")
    xavier = Employee.create!(name: "Xavier", email: "ProfX@marvel.com", phone: "911", salary: 60000.00)
    new_employee = Employee.create!(name: "Dan", email: "d@mail.com", phone: "914-555-5555", salary: 40000.00)
    old_employee = Employee.create!(name: "Yvonne", email: "Yvonne@urFired.com", phone: "919-123-4567", salary: 70000.00)
    a.add_employee(xavier)
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    assert_equal a.above_average_salary, "Xavier, Yvonne"
  end

  def test_employees_palindromes_name
    a = Department.create!(name: "Marketing")
    xavier = Employee.create!(name: "Xavier", email: "ProfX@marvel.com", phone: "911", salary: 70000.00)
    new_employee = Employee.create!(name: "Anna", email: "a@mail.com", phone: "915-444-1111", salary: 60000.00)
    old_employee = Employee.create!(name: "Yvonne", email: "Yvonne@urFired.com", phone: "919-123-4567", salary: 40000.00)
    a.add_employee(xavier)
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    assert_equal a.palindrome_in_department, "Anna"
  end

  def test_department_with_the_most_employees
    a = Department.create!(name: "Marketing")
    b = Department.create!(name: "IT")
    xavier = Employee.create!(name: "Xavier", email: "ProfX@marvel.com", phone: "911", salary: 70000.00)
    new_employee = Employee.create!(name: "Anna", email: "a@mail.com", phone: "915-444-1111", salary: 60000.00)
    old_employee = Employee.create!(name: "Yvonne", email: "Yvonne@urFired.com", phone: "919-123-4567", salary: 40000.00)
    a.add_employee(xavier)
